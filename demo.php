...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#contaact">CONTACT</a></li>
      </ul>
    </div>
...
<!-------contact------------------------------------>
   ...
   <div id="contaact" class="container-fluid bg-grey" style="background-color:#1f1f2e;">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" method="get" action="logincode.php">
  ...
  <div class="modal fade" id="Modal1" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
<form role="form" method="post" action="upl.php" enctype="multipart/form-data">               <div class="form-group" >
            ...
            <div class="form-group">
             ...
             <div class="form-group">
   <label for="pic"><span class="glyphicon glyphicon-eye-open"></span>  Select image to upload:</label>
            <input type="file" class="form-control" id="pic" name="pic"></div>
            <div class="checkbox">
              <label><input type="checkbox" value="" checked>Remember me</label>
            </div>
  ...
  <div class="modal fade" id="Modal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" method="get" action="forget_code.php">
            <div class="form-group">
